...
{ id: "PZ-H-006", lv: 16, q: "What was the first high-level programming language (1954)?", a: ["FORTRAN"], h: "FORmula TRANslation.", type: "TECH_HISTORY", difficulty: "HARD" },
{ id: "PZ-H-007", lv: 17, q: "Which company developed the Java programming language?", a: ["Sun"], h: "Sun Microsystems (later acquired by Oracle).", type: "TECH_HISTORY", difficulty: "MEDIUM" },
{ id: "PZ-H-008", lv: 18, q: "Who is credited with inventing the first mechanical computer (Difference Engine)?", a: ["Babbage"], h: "Charles ?.", type: "TECH_HISTORY", difficulty: "MEDIUM" },
{ id: "PZ-H-009", lv: 19, q: "What does the term 'bug' come from (legend involving Grace Hopper)?", a: ["moth"], h: "An actual ? was found in a relay of the Harvard Mark II.", type: "TECH_HISTORY", difficulty: "MEDIUM" },
{ id: "PZ-H-010", lv: 20, q: "Which protocol was the predecessor to the modern internet?", a: ["ARPANET"], h: "Advanced Research Projects Agency Network.", type: "TECH_HISTORY", difficulty: "HARD" }
];
...
{ id: "PZ-DS-004", lv: 24, q: "What map is used to simplify boolean expressions?", a: ["Karnaugh"], h: "K-map.", type: "DIGITAL_SYSTEMS", difficulty: "MEDIUM" },
{ id: "PZ-DS-005", lv: 25, q: "Which gate is known as the 'Universal Gate'?", a: ["NAND"], h: "Also NOR. Can build any other gate using only these.", type: "DIGITAL_SYSTEMS", difficulty: "MEDIUM" },
{ id: "PZ-DS-006", lv: 26, q: "How many bits are in a nibble?", a: ["4"], h: "Half a byte.", type: "DIGITAL_SYSTEMS", difficulty: "EASY" },
{ id: "PZ-DS-007", lv: 27, q: "What is the hex value of binary 1111?", a: ["F"], h: "Decimal 15 = Hex ?.", type: "DIGITAL_SYSTEMS", difficulty: "MEDIUM" },
{ id: "PZ-DS-008", lv: 28, q: "What component is the 'brain' of a computer's CPU?", a: ["ALU"], h: "Arithmetic Logic Unit.", type: "DIGITAL_SYSTEMS", difficulty: "MEDIUM" },
{ id: "PZ-DS-009", lv: 29, q: "A multiplexer with 4 inputs needs how many select lines?", a: ["2"], h: "2^n = 4 inputs.", type: "DIGITAL_SYSTEMS", difficulty: "MEDIUM" },
{ id: "PZ-DS-010", lv: 30, q: "What is 1's complement of 1010?", a: ["0101"], h: "Flip all bits.", type: "DIGITAL_SYSTEMS", difficulty: "EASY" }
];
...
{ id: "PZ-FC-004", lv: 34, q: "What book/concept contrasts top-down vs community-based development?", a: ["Cathedral"], h: "The ? and the Bazaar (Eric S. Raymond).", type: "FAMOUS_CONCEPTS", difficulty: "MEDIUM" },
{ id: "PZ-FC-005", lv: 35, q: "What test determines if a machine can exhibit intelligent behavior like a human?", a: ["Turing"], h: "The ? Test.", type: "FAMOUS_CONCEPTS", difficulty: "MEDIUM" },
{ id: "PZ-FC-006", lv: 36, q: "What is the 'rubber duck' method used for?", a: ["debugging"], h: "Explaining code to an object to find errors.", type: "FAMOUS_CONCEPTS", difficulty: "EASY" },
{ id: "PZ-FC-007", lv: 37, q: "What is the principle: 'Don't Repeat Yourself'?", a: ["DRY"], h: "Acronym for avoiding code duplication.", type: "FAMOUS_CONCEPTS", difficulty: "EASY" },
{ id: "PZ-FC-008", lv: 38, q: "What is the 'Garbage In, Garbage Out' acronym?", a: ["GIGO"], h: "Input quality determines output quality.", type: "FAMOUS_CONCEPTS", difficulty: "MEDIUM" },
{ id: "PZ-FC-009", lv: 39, q: "What law states that work expands to fill the time available for its completion?", a: ["Parkinson"], h: "Cyril Northcote ?'s Law.", type: "FAMOUS_CONCEPTS", difficulty: "HARD" },
{ id: "PZ-FC-010", lv: 40, q: "What is the 'Brooks's Law' regarding late software projects?", a: ["adding"], h: "? manpower to a late software project makes it later.", type: "FAMOUS_CONCEPTS", difficulty: "HARD" }
];
...
const allNew = [...techHistory, ...digitalSystems, ...famousConcepts, ...hardAptitude];
fs.writeFileSync('new_puzzles.json', JSON.stringify(allNew, null, 2));
console.log('Generated new_puzzles.json (ONLY specialized categories and hard aptitude)');
